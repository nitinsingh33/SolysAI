...
async def create_indexes():
    ...
    try:
        ...
        await database.comments.create_index([("oem", ASCENDING)], name="oem_index")
        await database.comments.create_index([("sentiment", ASCENDING)], name="sentiment_index")
        await database.comments.create_index([("date", ASCENDING)], name="date_index")
        await database.comments.create_index([("month", ASCENDING)], name="month_index")
